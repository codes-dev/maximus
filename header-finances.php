<?php
/**
 * The Financial header for our theme
 *
...
<div id="page" class="site">
	...
	<?php get_template_part( 'template-parts/navigation/themes/finances/navigation', 'top' ); ?>
	<?php get_template_part( 'template-parts/navigation/themes/finances/navigation', 'utils' ); ?>
	...
	if ( ( ! is_front_page() ) ) {
		...
		if ( function_exists( 'yoast_breadcrumb' ) ) {
			...
			// code...
			?>
					<nav class="navbar navbar-expand-lg shadow-0" aria-label="breadcrumb">
